...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox3" runat="server" Height="16px" Width="118px"></asp:TextBox>
                <br />
            </td>
        </tr>
        <tr>
            ...
            <td style="height: 175px">
                <asp:TextBox ID="TextBox4" runat="server" Height="21px" Width="315px"></asp:TextBox>
                &nbsp;
                <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged" Text="Show Details" />
                <br />
